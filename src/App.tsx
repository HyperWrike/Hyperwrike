...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-white font-sans text-[#000000] selection:bg-[#000000] selection:text-white flex flex-col">
      ...
      {/* SEO: Chennai AI Automation Agency content block */}
      <section className="py-16 px-6 md:px-8 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-serif mb-6 text-[#000000]">
            The #1 AI Automation Agency in Chennai
          </h2>
          <p className="text-base md:text-lg text-[#6F6F6F] leading-relaxed mb-6">
            Hyperwrike is a Chennai-based AI automation agency helping MSMEs and growing businesses across Tamil Nadu automate workflows, deploy AI agents, and scale operations — without hiring more people. We understand the Chennai business landscape and the unique challenges Indian SMEs face, from manual data entry to unmanaged customer follow-ups.
          </p>
          <p className="text-base text-[#6F6F6F] leading-relaxed mb-6">
            Whether you need AI chatbots, CRM automation, WhatsApp automation, or end-to-end workflow automation, Hyperwrike builds custom solutions tailored to your business — not off-the-shelf templates. Our Chennai team has delivered AI automation projects across retail, logistics, healthcare, real estate, and professional services.
          </p>
          <p className="text-base text-[#6F6F6F] leading-relaxed">
            Based in Chennai, serving pan-India. Book a free 30-minute AI audit with Hyperwrike and walk away with a clear automation roadmap — no commitment required.
          </p>
        </div>
      </section>
      ...
      <section id="faq" className="bg-[#050505] py-20 md:py-32 px-6 md:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 relative z-10">
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            {[
              { id: "faq_1", q: "What is an AI automation agency?", a: "An AI automation agency designs, builds, and deploys intelligent systems that automate repetitive business tasks — such as data entry, customer communications, reporting, and workflow management. Hyperwrike is a leading AI automation agency based in Chennai, Tamil Nadu, serving MSMEs and enterprises across India." },
              { id: "faq_2", q: "What is Hyperwrike and how does it work?", a: "Hyperwrike is an AI Automation & Custom Software Agency in Chennai. We help businesses eliminate manual work, deploy AI agents, and build bespoke software. Our process: Free AI Audit → Automation Blueprint → Build & Deploy → Monitor & Optimise." },
              { id: "faq_3", q: "How much does AI automation cost in Chennai?", a: "AI automation costs vary by project scope. Hyperwrike offers custom pricing based on your specific workflows and business size. Most clients see 40–70% reduction in operational costs within 90 days. Book a free consultation to get a tailored estimate." },
              { id: "faq_4", q: "Which industries does Hyperwrike serve?", a: "Hyperwrike serves MSMEs and enterprises across retail, e-commerce, manufacturing, healthcare, logistics, real estate, and professional services — primarily across Chennai, Tamil Nadu, and pan-India." },
              { id: "faq_5", q: "How fast can we see results from AI automation?", a: "Most Hyperwrike clients see significant operational cost savings within the first 90 days. Automations can often be deployed in as little as 2–4 weeks depending on complexity." },
              { id: "faq_6", q: "Is my data private and secure with Hyperwrike?", a: "Absolutely. We prioritize security in every build. You own 100% of the code and data we create for you — no vendor lock-in, ever." }
            ].map((faq, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
